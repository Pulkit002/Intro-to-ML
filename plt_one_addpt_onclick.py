...
class plt_one_addpt_onclick:
    ...
    def __init__(self, x, y, w, b, logistic=True):
        ...
        ax.scatter(x[pos], y[pos], marker='x', s=80, c = 'red', label="Class 1")
        ax.scatter(x[neg], y[neg], marker='o', s=100, label="Class 2", facecolors='none', edgecolors=dlblue,lw=3)
        ...
        ax.text(0.65,0.8,"Click anywhere on the graph to add more data points", size=10, transform=ax.transAxes)
...
#   @output.capture()  # debug
    ...
    def draw_thresh(self):
        ...
        c = self.ax[0].annotate("Class 1", xy= [xp5,0.5], xycoords='data',
        ...
        e = self.ax[0].annotate("Class 2", xy= [xp5,0.5], xycoords='data',
